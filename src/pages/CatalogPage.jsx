...
const CatalogPage = ({ cars, brands }) => {
  ...
  useEffect(() => {
    return enableCarouselWheel(document.getElementById('catalog-brands-container'))
  }, [])
  ...
  return (
    <div className="min-h-screen bg-custom-gray">
      {/* Static Header */}
      <header className="bg-custom-gray/20 backdrop-blur-md shadow-sm">
      ...
      <div className="py-[30px]">
        ...
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-8 pl-5">Каталог</h1>
