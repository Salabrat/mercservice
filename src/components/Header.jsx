      ...
      <header className={`bg-custom-gray/80 backdrop-blur-sm border-b border-gray-200/50 fixed top-0 left-0 right-0 z-50 transition-all duration-500 ease-in-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-full pointer-events-none'}`}>
        ...
        >
          {isMenuOpen ? <X className="w-8 h-8" /> : (
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 44 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="square" strokeLinejoin="miter" className="w-8 h-8">
              <line x1="4" x2="20" y1="6" y2="6" strokeWidth="2.5" />
              <line x1="4" x2="50" y1="12" y2="12" strokeWidth="1.5" />
              <line x1="4" x2="20" y1="18" y2="18" strokeWidth="2.5" />
            </svg>
          )}
        </button>
      </header>
